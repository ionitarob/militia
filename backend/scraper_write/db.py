    ...
    if params["fecha"] is None:
        ...
        cur.execute(
            ...
            ON CONFLICT (external_id) DO UPDATE SET
                ...
                prorrogas_meses     = EXCLUDED.prorrogas_meses,
                puntos_precio       = EXCLUDED.puntos_precio,
                puntos_mejoras      = EXCLUDED.puntos_mejoras,
                puntos_subjetivos   = EXCLUDED.puntos_subjetivos,
                organismo_id        = EXCLUDED.organismo_id,
                area_tecnologica_id = EXCLUDED.area_tecnologica_id
            RETURNING id
            """,
            params,
        )
